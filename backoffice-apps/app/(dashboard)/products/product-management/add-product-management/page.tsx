...
// Import fungsi yang benar dari lib (typo diperbaiki & sesuaikan fungsinya)
import { getCategories, createProduct } from "@/lib/product-management";
...
export default function AddProductPage() {
  ...
  // Efek untuk mengambil data kategori menggunakan fungsi dari lib
  useEffect(() => {
    async function fetchCategories() {
      try {
        // PERBAIKAN: Gunakan getCategories(), bukan getProducts()
  ...
  async function handleSave() {
    ...
    try {
      ...
      // PERBAIKAN: company_id dihapus sepenuhnya agar mengandalkan API Token
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-4 relative z-10">
            ...
            <div className="flex gap-3">
              <button
                type="button"
                className="flex-1 py-2 text-[#3b82f6] border border-gray-200 rounded-xl text-sm font-semibold hover:bg-blue-50 transition"
              >
                Edit
              </button>
              <button
