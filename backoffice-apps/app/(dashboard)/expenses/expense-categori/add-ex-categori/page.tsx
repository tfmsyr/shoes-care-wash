...
export default function FormExpenseCategoryPage() {
  ...
  async function handleSave() {
    ...
    if (id) {
      success = await updateExpenseCategory(id, payload);
    } else {
      success = await createExpenseCategory(payload);
    }

    if (success) {
      showToast("success", id ? "Category updated successfully!" : "Category added successfully!");
      ...
      showToast("error", id ? "Failed to update category. Please try again" : "Failed to add category. Please try again");
