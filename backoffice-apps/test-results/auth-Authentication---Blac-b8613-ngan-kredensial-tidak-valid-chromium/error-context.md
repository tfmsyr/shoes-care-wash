...
- Name: auth.spec.ts >> Authentication - Black Box Testing >> Login gagal dengan kredensial tidak valid
...
- text: No. HP *
- textbox "Masukkan no. HP Anda": "0000000000"
- text: Password *
- textbox "Masukkan kata sandi Anda": wrongpassword
- button:
  - img
- checkbox "Ingat saya"
- text: Ingat saya
